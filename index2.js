...
let ttd = setInterval(empty, 3000);
let ing ;
function empty (){
ing = Math.floor( Math.random()*3)
console.log(ing +" nowa");
   ...
   function wl1(){
    ...
    function wl2(){ if(document.querySelector(".main-two-and").innerHTML === "Current Order: none"){
        ...
        function myTimer() {
           ...
           document.querySelector(".main-two-and").innerHTML = "Current order: " + currentOrder[randomAw[1]] + " " + Math.floor(dm) +" min "+  ds + "s" ;
           clearInterval(zko);
...
function myTimer() {
   ...
   document.querySelector(".main-two-and").innerHTML = "Current order: " + currentOrder[randomAw[2]] + " " + Math.floor(dm) +" min "+  ds + "s" ;
   clearInterval(zkoz);
