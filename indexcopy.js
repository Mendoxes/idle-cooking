...
document.querySelector(".waiting-list1").innerHTML = "LOL";
   ...
   if (document.querySelector(".waiting-list1").innerHTML = "LOL"){
...
function myTim (){
   ...
   document.querySelector(".waiting-list1").innerHTML = "Awayting order: " + currentOrder[randomAw[0]] + " " + Math.floor(dmx) +" min "+  dsx + "s" ;
    ...
    let zko = setInterval(myTimz, 1000);
function myTimz (){
   ...
   document.querySelector(".waiting-list2").innerHTML =  "Awayting order: " + currentOrder[randomAw[1]] + " " + Math.floor(dmx1) +" min "+  dsx1 + "s" ;
    ...
    let zkoz = setInterval(myTimz1, 1000);
    function myTimz1 (){
       ...
       document.querySelector(".waiting-list3").innerHTML = "Awayting order: " + currentOrder[randomAw[2]] + " " + Math.floor(dmx2) +" min "+  dsx2 + "s" ;
        ...
        let zkoz1 = setInterval(myTimz2, 1000);
    function myTimz2 (){
    
       ddx3 = ddx3 -1 ;
         dsx3 = dsx3 -1;
       dmx3 = ddx3 / 60 ;
       if ( document.querySelector(".w4").classList.contains("okok")===true){

        document.querySelector(".okok").classList.remove("waiting-list4");
        document.querySelector(".okok").innerHTML = "Awayting order: " 
   ...
   //-----------------
        ...
        function wl1(){
let ok = setInterval(myTimer, 1000);
function myTimer() {
   ...
   document.querySelector(".main-two-and").innerHTML = "Current order: " + currentOrder[randomAw[0]] + " " + Math.floor(dm) +" min "+  ds + "s" ;
   clearInterval(ko);
...
for( i = 1 ; i < ingredienceL.length ;i++){
